...
(function (factory) {
  ...
  if (typeof exports == 'object') {
    // CommonJS
    factory(require('jquery'), require('src/assets/js/spin'))
  }
  else if (typeof define == 'function' && define.amd) {
    // AMD, register as anonymous module
    define(['jquery', 'src/assets/js/spin'], factory)
  }
  else {
    // Browser globals
  ...
  var modal_opts = {
    ...
    className: 'spinner-langheran', // The CSS class to assign to the spinner
